...
tags = ["career", "dont-be-that-person"]
keywords = ["CQRS", "best practices", "software development", "dogmatism", "technical decisions", "engineering culture"]
description = "Best practices don't age well. They emerge to solve specific problems, and when those problems fade, so should the dogma. So why do so many developers adopt techniques without asking what problem they were solving in the first place?"
