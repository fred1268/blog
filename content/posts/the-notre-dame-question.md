...
cover = "covers/the-notre-dame-question.png"
tags = ["ai", "history", "career"]
keywords = ["AI revolution", "industrial revolution", "craftsmanship", "Notre Dame", "knowledge work", "software development", "automation", "deep expertise"]
description = "The Industrial Revolution displaced skilled craftsmen with machines. Two centuries later, we scrambled to find those craftsmen to rebuild Notre Dame. The AI revolution is doing the same to knowledge workers—but a thousand times faster. What happens when we need the thinking craftsmen and discover they're gone?"
