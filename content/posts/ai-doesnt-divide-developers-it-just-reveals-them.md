...
cover = "covers/ai-doesnt-divide-developers-it-just-reveals-them.png"
tags = ["ai", "reflections"]
keywords = ["ai", "artificial intelligence", "developer mindset", "software craftsmanship", "coding philosophy", "developer experience", "journey vs destination", "productivity"]
description = "Developers have never been so divided over a technology. But the fault line isn't where most people think it is. It was already there, long before AI arrived."
...
Journey-oriented developers feel something closer to loss. What AI took from them isn't the output — it's the *path*. And often the path it chose isn't the one they would have taken. It works, but it doesn't feel elegant. It's not theirs. As I explored in [Why I code: it was never about the output](/posts/why-i-code-it-was-never-about-the-output/), programming was always an intellectual game — the output was just proof that you'd played it well. When the game is handed to an AI, supervision is what's left. And supervision was never the point.
