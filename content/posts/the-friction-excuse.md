...
cover = "covers/the-friction-excuse.png"
tags = ["career", "tech"]
keywords = ["big tech", "decision making", "friction", "engineering culture", "consensus", "organizational dysfunction", "software development", "technical debt"]
description = "Twice in a row, I proposed doing something the right way. Twice, the answer was the same: 'That would require convincing people.' Since when is that a reason not to do it?"
