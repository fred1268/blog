...
cover = "covers/the-peer-feedback-fallacy-more-judges-not-more-justice.png"
tags = ["management", "career"]
keywords = ["peer feedback", "performance review", "360 review", "bias", "management", "HR", "promotion", "hiring"]
description = "Evaluating humans is hard. So we invented peer feedback, hoping that multiplying subjective opinions would somehow produce objectivity. It doesn't. We've just dressed up bias in the clothes of consensus."
...
So what did we do? We invented peer feedback. The thinking, presumably, is that if you multiply subjective opinions, the average will be objective. That's... not how any of this works.
...
And then these peer opinions influence the manager: "Well, if Sarah — who's a strong engineer — says good things about Tom, it must be true." The bias compounds.
...
This isn't unlike [the autonomy trap](/posts/the-autonomy-trap/) I've written about before — where we diffuse decision-making to feel more democratic, but end up with no one truly accountable. Here, we diffuse evaluation to feel more objective, but end up with bias wearing the mask of consensus.
