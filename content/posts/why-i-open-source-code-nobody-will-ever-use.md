...
cover = "covers/why-i-open-source-code-nobody-will-ever-use.png"
tags = ["programming", "open-source"]
keywords = ["open source", "side projects", "software development", "developer motivation", "personal projects", "coding discipline", "github", "finishing projects"]
description = "A candid look at why I publish personal projects as open source—not because anyone will use them, but because the process of starting, sustaining, and finishing a project is its own reward. The real value isn't in the stars; it's in the discipline."
...
This mindset persisted for years. You could feel things gradually loosening—developers becoming slightly more open, slightly less protective—but progress was glacial. Then, as I mentioned in [an earlier article](/posts/java-a-revolutionary-language-that-overstayed-its-welcome/), open source finally became ubiquitous.
